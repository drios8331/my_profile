...
export const others = [
    {
        id: 1,
        image: "dtr720",
        title: "Radios de comunicacion",
        text: "Conocimientos en configuracion de radios de comunicacion ya sean de frecuencia(UHF y VHF) o punto a punto. ",
    },
    {
        id: 2,
        image: "Computador",
        title: "Computadores",
        text: "Amplios conocimientos en mantenimiento en mantenimiento y configuracion de computadores, redes y administracion de servidores.",
    },
    {
        id: 3,
        image: "Celular",
        title: "Celulares y Lineas Moviles",
        text: "Conocimiento en mantenimiento y configuracion de celulares, administracion, bloqueo, administracion de lineas moviles, optimizacion de costos con lineas moviles.",
    },
];
...
export const proyects = [
    {
        ...
        herramientas:
            "HTML5, CSS, PhP Nativo, Jquery, Composer, PhpSpreadsheet",
    },
    {
        id: 2,
        name: "ReservasVehiculos",
        imag1: "Reservasok",
        imag2: "Reservasok1",
        imag3: "Reservasok3",
        title: "Reservas Vehiculares",
        text: "Sistema de informacion creado con el fin de realizar reservas de vehiculos, ingresar vehiculos al inventario, este sistema cuenta con la implementacion de un calendario en la pagina principal el cual permite realizar seguimiento a las reservas activas.",
        herramientas: "HTML5, CSS, PhP Laravel, Ajax, Composer",
    },
    {
        id: 3,
        name: "ControlEscoltas",
        imag1: "Escoltas1",
        imag2: "Escoltas2",
        imag3: "Escoltas3",
    ...
    },
    {
        ...
        text: "",
        herramientas:
            "HTML5, CSS, PhP Nativo, Jquery, Ajax, Composer, PhpSpreadsheet",
    },
    {
        id: 5,
        name: "ControlAcceso",
    ...
    },
    {
        ...
        text: "",
        herramientas: "HTML5, CSS, ReactJS",
    },
];
